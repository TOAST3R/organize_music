defmodule OrganizeMusicTest do
  ...
  test "release_without_year" do
    assert OrganizeMusic.release_without_year("Zeta Reticula - EP 5 (2016) - [ELECTRIX008]"), "ep 5 [elextrix008]"
    assert OrganizeMusic.release_without_year("Zeta Reticula - EP 5 [ELECTRIX008]"), "ep 5 [elextrix008]"
