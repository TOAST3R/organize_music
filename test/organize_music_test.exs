defmodule OrganizeMusicTest do
  ...
  test "band_name" do
    assert OrganizeMusic.band_name("ZETA RETICULA - EP 5 (2016)"), "zeta reticula"
  ...
  test "release_without_year" do
    assert OrganizeMusic.release_without_year("Zeta Reticula - EP 5 (2016)"), "ep 5"
    assert OrganizeMusic.release_without_year("Zeta Reticula - EP 5"), "ep 5"
